...
def build_efficientnet_model():
    ...
    model.classifier = nn.Sequential(
        ...
        nn.ReLU(),
        nn.Dropout(0.3),
        nn.Linear(128, 1)  # Remove Sigmoid
    )
    return model
...
def main():
    ...
    device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
    run_dir = f"run_case1_equateSensitiveClass_a{alpha}"
    ...
    plot_tsne(X_server, X_server_smote, save_path="tsne_plot_case_1.png")
    ...
    print(f"Original samples: {len(X_server)}")
    print(f"After DeepSMOTE: {len(X_server_smote)}")
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig("ServerPretrainFairnessMetrics_case_1.png")
    plt.close()
    ...
    for comm_round in range(10):
        ...
        for client_name, client in clients.items():
            ...
            pred_bin = (pred_probs > 0).astype(int)
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig("global_metrics_case_1.png")
    plt.close()
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig("global_accuracy_case_1.png")
    plt.close()
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig("global_loss_case_1.png")
    plt.close()
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig("client_entropy_case_1.png")  # Save figure
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig("client_spd_case_1.png")
    plt.close()
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig("client_eod_case_1.png")
    plt.close()
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig("ServerPretrainLoss_case_1.png")
    plt.close()
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig("ServerPretrainAccuracy_case_1.png")
    plt.close()
